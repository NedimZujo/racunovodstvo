...
<!-- Button trigger modal -->
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      @foreach($amounts as $amount)
        ...
        @endif
              ...
              <tr>
                ...
                <td>{{$amount->type}}</td>
                <td class="text-right"><b class="{{$klasaType}}">{{$predznak.number_format($amount->amount, 2, ',', '.') }}</b></td>
                <td class="text-right">{{$amount->date}}</td>
                <td>{{$amount->name}}</td>
      ...
      <tfoot>
        <tr>
          <td ><b class="text-success">Total prihod:</b></td>
          <td class="text-right text-success"><b>{{number_format($totalPrihod, 2, ',', '.') }}</b></td>
          <td colspan="4"></td>
        </tr>
        <tr>
          <td><b class="text-danger">Total rashod:</b></td>
          <td class="text-right text-danger"><b>{{number_format($totalRashod, 2, ',', '.') }}</b></td>
          <td colspan="4"></td>
        </tr>
        <tr>
          <td><b>Total:</b></td>
