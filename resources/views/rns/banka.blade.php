  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <nav class="navbar navbar-light bg-light justify-content-between bg-light shadow style="width: 100%;border:1px solid #ddd">
        ...
        <form class="form-inline" method="POST" action="searchbanka">
          {{ csrf_field() }}
          <div class="form-group" >
            <label class="sr-only" for="From">From:</label>
           <input type="text" value="{{$datefrombanka}}" name="datefrombanka" class="datepicker form-control mr-sm-2" autocomplete="off">
          
            <label class="sr-only" for="exampleTo">To:</label>
            <input type="text" value="{{$datetobanka}}" name="datetobanka" class="datepicker form-control mr-sm-2" autocomplete="off">
      ...
      @foreach($amounts as $amount)
        ...
        @endif
          ...
          @if ($amount->transfer==0)
                 <form class="form-inline" method="POST" action="editbanka/{{$amount->id}}">
                     {{ csrf_field() }} 
